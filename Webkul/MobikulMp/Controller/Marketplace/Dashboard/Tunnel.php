...
namespace Webkul\MobikulMp\Controller\Marketplace\Dashboard;
...
/**
 * Webkul MobikulMp Account Dashboard Tunnel Controller.
 */
    ...
    public function execute()
    {
        ...
        if ($getEncodedParamData && $getEncryptedHashData) {
            ...
            if (Security::compareStrings($newEncryptedHashData, $getEncryptedHashData)) {
                $params = null;
                $paramsJson = $this->base64Json->unserialize(urldecode($getEncodedParamData));
                if ($paramsJson) {
