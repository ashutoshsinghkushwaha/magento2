...
class InstallData implements InstallDataInterface
{
     ...
     */
    public const APPROVE_ACCOUNT = 'approve_account';
    ...
    public function install(ModuleDataSetupInterface $setup, ModuleContextInterface $context)
    {
        ...
        $customerSetup->addAttribute(
            ...
            'label' => 'Is Vendor?',
            'input' => 'select',
            "source"   => Vrize\Vendor\Model\Config\Source\CustomerYesNoOptions::class,
            'required' => false,
            'default' => '0',
            'visible' => true,
            'user_defined' => true,
        ...
        $setup->getConnection()->insertForce(
            ...
            ['customer_group_code' => 'Seller', 'tax_class_id' => 3]
        );
        $setup->endSetup();
    }
}
